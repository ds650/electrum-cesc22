...
a = Analysis([electrum+ MAIN_SCRIPT,
              electrum+'electrum_cesc/gui/qt/main_window.py',
              electrum+'electrum_cesc/gui/text.py',
              electrum+'electrum_cesc/util.py',
              electrum+'electrum_cesc/wallet.py',
              electrum+'electrum_cesc/simple_config.py',
              electrum+'electrum_cesc/bitcoin.py',
              electrum+'electrum_cesc/blockchain.py',
              electrum+'electrum_cesc/dnssec.py',
              electrum+'electrum_cesc/commands.py',
              electrum+'electrum_cesc/plugins/cosigner_pool/qt.py',
              electrum+'electrum_cesc/plugins/email_requests/qt.py',
              electrum+'electrum_cesc/plugins/trezor/qt.py',
              electrum+'electrum_cesc/plugins/safe_t/client.py',
              electrum+'electrum_cesc/plugins/safe_t/qt.py',
              electrum+'electrum_cesc/plugins/keepkey/qt.py',
              electrum+'electrum_cesc/plugins/ledger/qt.py',
              electrum+'electrum_cesc/plugins/coldcard/qt.py',
              ],
             binaries=binaries,
             datas=datas,
